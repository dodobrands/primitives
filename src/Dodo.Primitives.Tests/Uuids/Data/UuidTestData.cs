...
namespace Dodo.Primitives.Tests.Uuids.Data
{
    ...
    public static class UuidTestData
    {
        ...
        // --- N ---
        // ---------
        public static UuidStringWithBytes[] CorrectNStrings { get; } = NStrings;
        ...
        // --- D ---
        // ---------
        public static UuidStringWithBytes[] CorrectDStrings { get; } = DStrings;
        ...
        // --- B ---
        // ---------
        public static UuidStringWithBytes[] CorrectBStrings { get; } = BStrings;
        ...
        // --- P ---
        // ---------
        public static UuidStringWithBytes[] CorrectPStrings { get; } = PStrings;
        ...
        // --- X ---
        // ---------
        public static UuidStringWithBytes[] CorrectXStrings { get; } = XStrings;
